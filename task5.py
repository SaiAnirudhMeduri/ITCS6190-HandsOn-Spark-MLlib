...
if not os.path.exists(MODEL_PATH):
    ...
    hist_features = hist_windowed_df.withColumn("hour_of_day", hour(col("window.start"))).withColumn(
        "minute_of_hour",
...
windowed_features = windowed_df.withColumn("hour_of_day", hour(col("window.start"))).withColumn(
    "minute_of_hour",
    minute(col("window.start"))
)
